...
public class XiaoPushDown : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            if(this.GetComponent<BallShoot>().enabled == false && isUsedSpell == false)
            {
                ...
                gameObject.transform.GetChild(0).GetComponent<SummonerEfferct>().setChareckteristics(Random.Range(3, 5),
    ...
    IEnumerator setMasToBack(float value)
    {
        ...
        gameObject.transform.GetChild(1).GetComponent<SummonerEfferct>().setChareckteristics(Random.Range(3, 5), 
            new Vector2(0, Random.Range(0.2f, 0.65f)), Random.Range(500, 1000),
